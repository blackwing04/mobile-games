...
## scene_end_lost_sanity — 壞結局《留校生》— v2 ✅ 已收（**第二版，覆蓋第一版；title 使用者拍板《留校生》**）
...
**narrative 強點**：
- 「臉像蠟融化，露出平滑沒五官的皮膚」= IP「熟人模仿」本質揭露
- 「妳不再感到恐懼，反而覺得那種空洞異常地親切」= 詛咒侵蝕的最終勝利
- 「最後一點自我，就像被抹布擦掉的字跡」= 自我消失的詩意化
- 「最乖巧的學生」= 校園 IP 反諷
- **結尾「你在哪？我在教室等妳⋯⋯」= 完美 callback scene_end_curse_spread 的「你在哪？我在學校等你⋯⋯」**，IP「下一個誘餌」母題兩個變體

**跟 curse_spread / lost_soul 的差異**：
- `curse_spread`：妹妹被吞噬 → 手機自動撥電話 → 「你在哪？我在學校等你⋯⋯」（**跨地點誘餌 / 給男朋友**）
- `lost_sanity`：妹妹被同化 → 變留校生 → 「你在哪？我在教室等妳⋯⋯」（**原地誘餌 / 等新獵物進校園**）
- `lost_soul`：聽見自己說「好」→ 跟著哥哥跳天台（**主動屈服死**）
- 三個壞結局質地完全不同，光譜飽滿
