...
| `scene_end_self_break`（**好結局《逃出生天》**）| ✅ **v2 已收 narrative**（使用者寫）。觸發路線：scene_the_climax Choice 3 (resolve 賭) **大成功**。性質好結局 — 妹妹意志擊退詛咒、平安回家。但結尾「哥哥微微上揚的僵硬弧度」留下曖昧暗示（玩家自己詮釋）|
...
## scene_end_self_break — 好結局《逃出生天》（v2 ✅ 已收）
...
**結局類型**：**好結局**（使用者拍板 — narrative 結尾的「哥哥僵硬弧度」是給玩家自由詮釋的曖昧 hook，不影響結局本身屬性）

**觸發路線**：scene_the_climax Choice 3「（閉上眼大喊）這一切都是假的！通通消失！」— resolve 檢定 **大成功**

**narrative 強點**：
- 「玻璃碎裂聲 + 哥哥扭曲嘆息」= 詛咒幻覺被擊破的瞬間
- 「通話紀錄全部消失」= 詛咒自我清理，但同時也是「妹妹真的逃出來」的證據
- 妹妹封鎖通話 → 衝回家 → 真哥哥在客廳 → 平安重逢
- 結尾「哥哥微微上揚的僵硬弧度」= 留給玩家自由詮釋的曖昧 hook（可解讀為妹妹 PTSD 的妄想，或是 Ch3 男朋友視角伏筆的延伸）

---

## scene_end_lost_sanity — 壞結局《失神》⚠️ title 待拍板（建議改《理智斷裂》/《呢喃》避免跟 lost_soul 同名）— v2 ✅ 已收

> 「這一切都是假的⋯⋯假的⋯⋯」
>
> 妳試圖嘶吼，但聲音卻像被這濃稠的紅霧吞噬了一般，微弱得連妳自己都聽不見。妳的理智在這一刻像是一根繃緊到極限的琴弦，隨著掛鐘那聲刺耳的「喀擦」聲，徹底斷裂。
>
> 妳眼前的世界開始旋轉、崩塌。哥哥的身影在妳模糊的視線中重疊、扭曲，最後變回了那個沒有五官、平滑得令人作嘔的蒼白輪廓。
>
> 但這一次，妳不再感到恐懼了。
>
> 那種刺骨的惡寒轉化為一種奇異的溫暖，妳感覺到那雙冰冷的手輕輕撫摸著妳的頭，那個空洞的聲音直接在妳腦海中迴盪，溫柔得像是一首搖籃曲：
>
> 「累了吧？乖⋯⋯別再掙扎了。過來，這裡有妳想要的一切。」
>
> 妳的雙眼徹底失去了神采，漆黑的瞳孔中倒映不出任何光線。妳像是一具斷了線的木偶，帶著僵硬而空洞的微笑，緩緩走向天台的邊緣。
>
> 妳聽見背後傳來無數個聲音在低語，在那之中，妳甚至聽見了自己的聲音在輕笑。
>
> 當妳跨出最後一步時，時間剛好跳到了 23:47。
>
> 妳沒有感覺到墜落的恐懼，只覺得自己終於融入了那片無邊無際的深紅之中。隔天，校園裡一切如常，除了一個永遠留在天台上、定格在那個時間點的虛幻殘影。

**結局類型**：壞

**觸發路線**：scene_the_climax Choice 3「（閉上眼大喊）這一切都是假的！通通消失！」— resolve 檢定 **失敗**

**title 待拍板**：
- (A) 《理智斷裂》— 跟 ID lost_sanity 直接對應
- (B) 《心智崩潰》— 略文學
- (C) 《呢喃》— 對應結尾「無數個聲音在低語」「自己的聲音在輕笑」最 IP 神秘
- (D) 共用《失神》— 但會跟 scene_end_lost_soul 同名，collection 會顯示兩張《失神》卡片

**narrative 強點**：
- 「但這一次，妳不再感到恐懼了」= IP 侵蝕高潮，妹妹接受了詛咒
- 「累了吧？乖⋯⋯別再掙扎了」= 詛咒針對「精神疲累」的最終誘惑
- 「漆黑的瞳孔中倒映不出任何光線」= 視覺死亡，不血腥
- 「23:47 跨出最後一步」= IP 時間錨點完美 timing
- 「永遠留在天台上、定格在那個時間點的虛幻殘影」= 妹妹變成詛咒的一部分，比直接寫死更恐怖

**跟 lost_soul 的動作層差異**：
- `lost_soul`：聽見自己說「好」(主動屈服 / self-betrayal)
- `lost_sanity`：試圖反抗但失敗 (抵抗失敗 / resistance failure)
- 兩個都是「妹妹被詛咒帶走墜樓」，但玩家動作層完全不同 — 整章「失神類」結局有兩種光譜
